...
class cVAE_MLPConfig(cVAEmodelConfigABC):
    ...
    Defines encoder, decoder, and optional conditioning architecture.
...
class cVAE_MLP(cVAEmodelsABC):
    ...
    Implements encoder-decoder architecture with optional conditioning,
    latent sampling, and support for flow-based priors.
    ...
    def __init__(
        ...
        Constructs encoder, decoder, and optional condition embedding
        networks based on configuration. Validates input/output shapes
        and optionally loads checkpoint weights.
