...
required_sample_dimensions = frozenset(set(data["required_sample_dimensions"]))
optional_sample_dimensions = frozenset(set(data["optional_sample_dimensions"]))
supported_NN_dimensions_sorted = data["supported_NN_dimensions_sorted"]
